...
def build_maps_link(lat, lng, name=""):
...
- 🏠 {r['address']}
                ...
                # ✅ GOOGLE MAPS NAVİGASYON LİNKİ
                if r.get("lat") and r.get("lng"):
                    maps_url = f"https://www.google.com/maps/dir/?api=1&destination={r['lat']},{r['lng']}&travelmode=driving"
                    st.markdown(f"[🧭 Yol Tarifi Al]({maps_url})")
